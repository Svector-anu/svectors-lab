...
- roblambert9/x402-vercel-gateway (0★) — production reference gateway for protecting FastAPI endpoints with x402 on Vercel
- edycutjong/retainer (0★) — Hedera renewal service that recharges recurring API access after a one-time x402 payment
...
- [GitHub repository search API — broad x402 query, 2026-09-08](https://api.github.com/search/repositories?q=x402%20in%3Areadme%2Cdescription%20pushed%3A%3E%3D2026-09-01&sort=updated&order=desc&per_page=100)
- [npm downloads: @coinbase/x402 — week ending 2026-09-06](https://api.npmjs.org/downloads/point/last-week/%40coinbase%2Fx402)
- [npm downloads: x402 — week ending 2026-09-06](https://api.npmjs.org/downloads/point/last-week/x402)
