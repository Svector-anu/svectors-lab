...
The secured leaderboard above contains all 11 merged PRs. New since the prior poll: [Cosmian/kms#1163](https://github.com/Cosmian/kms/pull/1163), merged 2026-09-15.
...
| Date | Repo | Stars | PR | Severity | Title |
|---|---|---:|---|---|---|
| 2026-09-09 | emilk/egui | 30534 | [#8481](https://github.com/emilk/egui/pull/8481) | PRE-HISTORY | fix(deps): bump event-listener |
| 2026-09-03 | affaan-m/ECC | 260821 | [#2934](https://github.com/affaan-m/ECC/pull/2934) | PRE-HISTORY | fix(deps): bump @humanfs/node |
| 2026-08-25 | dani-garcia/vaultwarden | 67956 | [#7651](https://github.com/dani-garcia/vaultwarden/pull/7651) | PRE-HISTORY | fix(deps): bump h2 |

## Queued / submitted / cleanup (11 retained drafts)

| Severity | Repo | Stars | State | Age |
|---|---|---:|---|---:|
| MEDIUM | DigitalShieldOfficial/USDTPAY-woocommerce | 2 | cleanup (sent) | 30d |
| MEDIUM | NeoSoul-AI/neotrade-wallet-sdk | 0 | pending, auto-send armed | 8d |
| MEDIUM | ZSvirt/zsvirt | 1690 | escalate, email delivery blocked | 25d |
| CRITICAL | ZSvirt/zsvirt | 1690 | operator-todo | 25d |
| HIGH | amirh00sain/SpiderPanel | 1282 | cleanup (email-sent) | 23d |
