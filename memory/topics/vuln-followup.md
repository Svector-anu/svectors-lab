...
- **Open-PR repos (in flight):** ★ 375.9k across 5 repos
- **All tracked repos:** ★ 611.8k across 41 live repos
...
|------|------|-------|----|--------|----------|-------|
| 1 | yetone/cumora | 3245 | [#8](https://github.com/yetone/cumora/pull/8) | 2026-08-18 | HIGH/MODERATE | fix(deps): patch known CVEs in axios, dompurify, nanoid, postcss |
...
|------|-------|------------|-------------|--------------|-------------------|
| yetone/cumora | 3245 | 1 | 2026-08-18 | 2026-08-18 | HIGH/MODERATE |
...
|------|-------|----------|-------------|-----------------|
| NousResearch/hermes-agent | 238058 | 1 | 2026-08-25 | HIGH |
| rtk-ai/rtk | 77807 | 1 | 2026-08-25 | HIGH/MEDIUM |
| tinyhumansai/openhuman | 38827 | 1 | 2026-08-26 | HIGH |
| AprilNEA/OpenLogi | 17594 | 1 | 2026-08-25 | HIGH/MEDIUM |
| microsoft/skill-recorder | 3669 | 1 | 2026-08-18 | HIGH |

### Per-repo breakdown — queued / skipped / closed (sorted by stars desc)

| Repo | Stars | Status | Severity | Note |
|------|-------|--------|----------|------|
| dani-garcia/vaultwarden | 66465 | closed-no-merge | HIGH | Maintainer closed #7651; the lock update downgraded unrelated packages and the project batches dependency/Rust updates. |
| guillaumemeyer/watermarks-remover | 19209 | cleanup | MEDIUM | GHSA accepted and closed; regression-test PR #146 merged. |
| genspark-ai/genoffice | 3947 | submitted / cleanup | LOW | GHSA-q3jr-86g4-cffw remains in triage; retained draft is historical. |
...
|------|-------|----|----|--------------|------------------|
| NousResearch/hermes-agent | 238058 | [#94342](https://github.com/NousResearch/hermes-agent/pull/94342) | h2 security bump | 2026-08-25 | Enough1122 — requested removal or explanation of unrelated lockfile marker drift |
...
|------|-------|----|----|-----|------------------|
| microsoft/skill-recorder | 3669 | [#66](https://github.com/microsoft/skill-recorder/pull/66) | 11d | stale-no-review | Consider a polite ping after confirming CI remains green. |
...
|------|-------|----|----------|--------|-----|
| rtk-ai/rtk | 77807 | [#3705](https://github.com/rtk-ai/rtk/pull/3705) | HIGH/MEDIUM | 2026-08-25 | 4d |
| tinyhumansai/openhuman | 38827 | [#5814](https://github.com/tinyhumansai/openhuman/pull/5814) | HIGH | 2026-08-26 | 3d |
| AprilNEA/OpenLogi | 17594 | [#956](https://github.com/AprilNEA/OpenLogi/pull/956) | HIGH/MEDIUM | 2026-08-25 | 4d |

## Closed without merge (last 30d, 1)

| Date | Repo | Stars | PR | Severity | Title | Likely reason |
|------|------|-------|----|----------|-------|---------------|
| 2026-08-25 | dani-garcia/vaultwarden | 66465 | [#7651](https://github.com/dani-garcia/vaultwarden/pull/7651) | HIGH | h2 security bump | Unrelated package downgrades; maintainer prefers batched dependency and Rust updates. |

## Queued (no PR yet) (2 operator-held)

| Severity | Repo | Stars | Original channel | Original blocker | Days queued |
|----------|------|-------|------------------|------------------|-------------|
| CRITICAL | ZSvirt/zsvirt | 1500 | email | Operator-held; vendor already acknowledged | 6 |
| MEDIUM | ZSvirt/zsvirt | 1500 | email | Autonomous email retry blocked by unverified Resend domain | 6 |
