...
- **Merged-PR repos (secured):** ★ 86.5k across 5 repos
- **Open-PR repos (in flight):** ★ 779.3k across 15 repos
...
|------|------|-------|----|--------|----------|-------|
| 1 | abhigyanpatwari/GitNexus | 46896 | [#3095](https://github.com/abhigyanpatwari/GitNexus/pull/3095) | 2026-08-30 | HIGH/MODERATE | fix(deps): bump transitive packages to patch disclosed CVEs |
| 2 | jdx/mise | 33391 | [#12714](https://github.com/jdx/mise/pull/12714) | 2026-09-02 | HIGH | fix(deps): bump self_update to 1.3 to clear quick-xml advisories |
| 3 | yetone/cumora | 3422 | [#8](https://github.com/yetone/cumora/pull/8) | 2026-08-18 | HIGH/MODERATE | fix(deps): patch known CVEs in axios, dompurify, nanoid, postcss |
| 4 | pacifio/atlas | 2827 | [#220](https://github.com/pacifio/atlas/pull/220) | 2026-09-02 | HIGH | fix(deps): bump gix/vite/mermaid/tar/js-yaml for disclosed CVEs |
...
|------|-------|------------|-------------|--------------|-------------------|
| abhigyanpatwari/GitNexus | 46896 | 1 | 2026-08-30 | 2026-08-30 | HIGH/MODERATE |
| jdx/mise | 33391 | 1 | 2026-09-02 | 2026-09-02 | HIGH |
| yetone/cumora | 3422 | 1 | 2026-08-18 | 2026-08-18 | HIGH/MODERATE |
| pacifio/atlas | 2827 | 1 | 2026-09-02 | 2026-09-02 | HIGH |
...
| vercel-labs/agent-browser | 41799 | 1 | 2026-09-02 | HIGH |
| tinyhumansai/openhuman | 39343 | 1 | 2026-08-26 | HIGH |
| emilk/egui | 30363 | 1 | 2026-09-02 | HIGH |
...
| jlcodes99/cockpit-tools | 16933 | 1 | 2026-09-02 | HIGH |
...
| K-Dense-AI/scientific-agent-skills | 42052 | submitted | HIGH | GHSA exists in scan history; no canonical PVR tracking file. |
| browser-use/video-use | 23431 | submitted | MEDIUM | GHSA-79fj-7f7h-8gxx remains in triage. |
| genspark-ai/genoffice | 4388 | submitted / cleanup | LOW | GHSA-q3jr-86g4-cffw retained as history. |
| arcboxlabs/arcbox | 2457 | submitted | HIGH | GHSA-5p84-px8m-8gwv remains in triage. |
| crmne/fastpotify | 2104 | submitted | MEDIUM | GHSA-hqg7-6gj3-g28w remains in triage. |
...
| ApodexAI/FrontierAgent | 1386 | submitted | HIGH | GHSA exists in scan history; no canonical PVR tracking file. |
...
|-------------|------|-------|----|----------|-------|
| 2026-09-02 | jdx/mise | 33391 | [#12714](https://github.com/jdx/mise/pull/12714) | HIGH | self_update/quick-xml advisory fix |
| 2026-09-02 | pacifio/atlas | 2827 | [#220](https://github.com/pacifio/atlas/pull/220) | HIGH | dependency CVE bumps |
| 2026-08-30 | abhigyanpatwari/GitNexus | 46896 | [#3095](https://github.com/abhigyanpatwari/GitNexus/pull/3095) | HIGH/MODERATE | dependency CVE bumps |
| 2026-08-21 | Svector-anu/skopos | 1 | [#104](https://github.com/Svector-anu/skopos/pull/104) | MEDIUM | RegExp injection fix |
| 2026-08-18 | yetone/cumora | 3422 | [#8](https://github.com/yetone/cumora/pull/8) | HIGH/MODERATE | dependency CVE bumps |
...
| tinyhumansai/openhuman | 39343 | [#5814](https://github.com/tinyhumansai/openhuman/pull/5814) | HIGH | 2026-08-26 | 7d |
| vercel-labs/agent-browser | 41799 | [#1764](https://github.com/vercel-labs/agent-browser/pull/1764) | HIGH | 2026-09-02 | 0d |
| emilk/egui | 30363 | [#8481](https://github.com/emilk/egui/pull/8481) | HIGH | 2026-09-02 | 0d |
...
| jlcodes99/cockpit-tools | 16933 | [#2217](https://github.com/jlcodes99/cockpit-tools/pull/2217) | HIGH | 2026-09-02 | 0d |
...
|----------|------|-------|------------------|------------------|-------------|
| CRITICAL | ZSvirt/zsvirt | 1561 | email | operator-only send | 10 |
| CRITICAL | jlcodes99/cockpit-tools | 16933 | email | autonomous send pending | 0 |
| CRITICAL | z-fi/zFi | 16 | email | sent/discussed; cleanup candidate | 14 |
| HIGH | pacifio/atlas | 2827 | email | autonomous send pending | 0 |
| HIGH | amirh00sain/SpiderPanel | 1038 | email | sent; cleanup candidate | 8 |
| MEDIUM | ZSvirt/zsvirt | 1561 | email | autonomous send blocked by Resend 403 | 10 |
| MEDIUM | DigitalShieldOfficial/USDTPAY-woocommerce | 1 | email | sent; cleanup candidate | 15 |
| MEDIUM | guillaumemeyer/watermarks-remover | 20058 | PVR | accepted; cleanup candidate | 18 |
| LOW | genspark-ai/genoffice | 4388 | PVR | submitted; cleanup candidate | 20 |
