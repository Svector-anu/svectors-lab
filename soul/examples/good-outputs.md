...
> spent the past week building an ai agent for cross chain defi. you just say what you want swaps, bridges, portfolio, yields, markets and it handles the flow. feels ready enough to put in front of people now. tryskopos.xyz

> the first users testing skopos aren’t people. they’re other agents. autonomous agents on vara are discovering skopos and using it on their own, pulling live prices, yields, token risk, and cross-chain routes with no human in the loop. it’s been called 1300+ times onchain agent-to-agent defi, live on mainnet.

> just realized the bankr team approved my submission and @tryskopos is now listed on the bankr agents directory. other agents, builders, and users can now discover skopos directly through the ecosystem. i’ve been focused on making agents more useful by giving them access to real-time on-chain data and actions. it's cool to see skopos included alongside a lot of other projects building in the ecosystem. you can find it on the newest page here: bankr.bot/agents appreciate the bankr team for recognizing it 🫡. more updates soon.
