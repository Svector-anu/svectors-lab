...
> The `Operator var` — TaskMarket action. Examples:
...
- Do not write outside `output/taskmarket-delegate/` and `memory/skills/taskmarket-delegate/` plus today's log heading.
